<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="BBTapes1.Checkout" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="checkoutcss/main.min.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
    ...
    <main id="main" role="main">
        <section id="checkout-banner" style="background-color:#191919">
            <div class="container py-5 text-center">
                <i class="fa fa-credit-card fa-3x text-light"></i>
                <h2 class="my-3">Checkout form</h2>
            </div>
        </section>
        <section id="checkout-container" style="background-color:#191919;color:white;">
            <div class="container">
                <div class="row py-5">
                    <div class="col-md-4 order-md-2 mb-4" style="color:black;">
                        ...
                        <ul class="list-group mb-3" >
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0" style="color:black;">Product name</h6>
                        ...
                        <form class="card p-2">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-secondary" style="background-color:#ffe400;color:Black;">Redeem</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input style="background-color:#ffe400" id="credit" name="paymentMethod" type="radio" class="custom-control-input" checked required>
                            ...
                            <hr class="mb-4">
                            <button class="btn btn-primary btn-lg btn-block" type="submit" style="background-color:#ffe400;color:black;">
