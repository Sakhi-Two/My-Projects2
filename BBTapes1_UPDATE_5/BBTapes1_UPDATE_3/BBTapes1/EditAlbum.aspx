<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditAlbum.aspx.cs" Inherits="BBTapes1.EditAlbum" %>
		...
		<div class="container-login100" style="background-image: url('img/headVBG.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Artist ID is required">
						<input class="input100" type="text" id="arID" runat="server" name="artistid" placeholder="Arist ID">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<asp:Button class="login100-form-btn" id="Edit" Text="Edit Album" OnClick="BtEdit_Click" runat="server"/>	
						</div>
					</div>
