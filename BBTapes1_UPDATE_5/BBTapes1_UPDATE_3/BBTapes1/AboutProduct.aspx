<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AboutProduct.aspx.cs" Inherits="BBTapes1.AboutProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
      	<!--  section -->
	<section class="page-info-section set-bg" data-setbg="img/vinyl.jpg">
		<div class="container">
			<div class="section-title text-center" >
				<h2 id="Musictype" runat="server">OLD SCHOOL</h2>	
			</div>
		</div>
	</section>
	<!--  section end -->
	...
	<section class="Catalogue-section" >
		<div class="container">
			<div class="row" id="Images" runat="server">
